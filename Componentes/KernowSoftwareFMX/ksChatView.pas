...
type
  ...
  public
    ...
    procedure AddChatBubble(AText: string;
                            ...
                            const AUserImage, AImgMsg: TBitmap);
    procedure Clear;
    procedure ClearEdit;
...
procedure TksChatView.AddChatBubble(AText: string; APosition: TksTableViewChatBubblePosition; AColor, ATextColor: TAlphaColor; const AUserImage, AImgMsg: TBitmap);
var
...
begin
  ...
  //Genilson em 10-10-2020
  if Copy(aInfo.Text, 1, 3) = 'JPG' Then begin
     FTableView.Items.AddChatBubble(aInfo.Text, APosition, AInfo.Color, AInfo.Color, AUserImage);
     FTableView.Items.LastItem.DrawBitmap(AImgMsg, ARect, Leading);
  end
  else
...
begin
  ...
  AddChatBubble(AInfo.Text, ksCbpLeft, AInfo.Color, AInfo.TextColor, FMyImage, Nil);
  FEdit.Edit.Text := '';
end;
